...
import { SSEServerTransport } from "@zaptomcp/sdk/server/transports/sse";
import { z } from "zod";
import type { CallToolResult } from "@zaptomcp/sdk/types";
...
app.withTypeProvider<ZodTypeProvider>().get("/mcp", async (_, res) => {
