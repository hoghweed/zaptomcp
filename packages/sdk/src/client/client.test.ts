...
describe("Client", () => {
  it("should initialize with matching protocol version", async () => {
  ...
  it("should initialize with supported older protocol version", async () => {
  ...
  it("should respect server capabilities", async () => {
  ...
  it("should respect client notification capabilities", async () => {
    const server = new Server(
      {
        name: "test server",
        version: "1.0",
  ...
  it("should only allow setRequestHandler for declared capabilities", () => {
    const client = new Client(
      {
        name: "test client",
        version: "1.0",
  ...
  it("should handle client cancelling a request", async () => {
    const server = new Server(
      {
        name: "test server",
        version: "1.0",
