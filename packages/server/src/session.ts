...
import type { FastMCPSessionAuth, FastMCPSessionEventEmitter, LoggingLevel, Prompt, Resource, ResourceTemplate, Tool, InputResourceTemplate, ArgumentValueCompleter, InputPrompt, SamplingResponse, CompletionZodSchema, ContentResult, Progress, SerializableValue, ContentResultZodSchema } from "./types.js";
...
export class FastMCPSession<T extends FastMCPSessionAuth = FastMCPSessionAuth> extends FastMCPSessionEventEmitter {
    ...
    constructor({
        auth, name, version, tools, resources, resourcesTemplates, prompts,
    }: {
        auth?: T;
        name: string;
        version: string;
